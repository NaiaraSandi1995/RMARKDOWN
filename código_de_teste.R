...
author:
- 'Analista: Naiara Sandi de Almeida Alcantara'
- 'Estagiário: Paulo Henrique Souza de Oliveira'
output:
  word_document:
    number_sections: yes
...
<center>
---          
Relatório vinculado ao Contrato Nº ECE-DSS-4604/2022 - Pesquisa de Posses e Hábitos de Uso de Equipamentos Elétricos na Classe Comercial e de Serviços  
...
<center>`r format(Sys.Date(),"%d de %B de %Y")`</center>
